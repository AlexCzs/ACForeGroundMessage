...
extern NSString *const ForeGoundViewDidClick;    //监听点击弹窗的事件

@interface ACForeGroundNotification : NSObject
...
static FoureGroundView *SharedFourGroundView;
